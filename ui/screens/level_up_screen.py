...
class LevelUpScreen:
    ...
    def draw(self, choices: list) -> None:
        ...
        # Tiêu đề
        title      = self.font_big.render("LÊN CẤP! — Chọn phần thưởng", True, (255, 220, 80))
        ...
        # Gợi ý phím
        hint = self.font_small.render("Nhấn  1 / 2 / 3  hoặc click vào card",
                                      True, (160, 160, 160))
    ...
    def _draw_stat_card(self, upgrade, rect: pygame.Rect, idx: int) -> None:
        ...
        # Badge "CHỈ SỐ"
        badge_surf = self.font_small.render("CHỈ SỐ", True, (r, g, b))
        self.screen.blit(badge_surf, (rect.x + 10, rect.y + 10))
